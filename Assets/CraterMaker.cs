...
public class CraterMaker : MonoBehaviour {
	...
	void Update () {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            int x = (int)Mathf.Lerp(0, xResHeight, Mathf.InverseLerp(0, terrainData.size.x, mousePos.x));
            int z = (int)Mathf.Lerp(0, yResHeight, Mathf.InverseLerp(0, terrainData.size.z, mousePos.z));
            ...
            // Apply texture
            int g = (int)Mathf.Lerp(0, xResAlpha, Mathf.InverseLerp(0, terrainData.size.x, mousePos.x));
            var b = (int)Mathf.Lerp(0, yResAlpha, Mathf.InverseLerp(0, terrainData.size.z, mousePos.z));
